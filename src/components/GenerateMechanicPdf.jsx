      ...
      <>
                  ...
                  <table className="car-info-table">
                     <tbody>
                        ...
                        <tr className='car-table-row'>
                           ...
                           <td className='data'>{ targetAvaluo.content.weightCapacity }</td>
                        </tr>
                        <tr className='car-table-row'>
                           ...
                           <td className='data'>{ targetAvaluo.content.tara }</td>
                        </tr>
                        <tr className='car-table-row'>
                           ...
                           <td className='data'>{ targetAvaluo.content.maxCapacity }</td>
                        </tr>
                        <tr className='car-table-row'>
         ...
         <section className="pdf-container avaluo-page">
            ...
            <section className="car-expenses">
               <header className='car-header'>
                  <p>INFORME DE DIAGNÓSTICO MECÁNICO</p>
                  <p>PAGINA 2-2</p>
                  <p className='serial'>{ uniqueDocId }</p>
               </header>
               ...
               <section className={ isResponsive
                     ? 'expenses-square diagnostico responsive'
                     : 'expenses-square diagnostico'
                  }>
               ...
               {/* <section className="expenses">
                  <section className="expenses__header">
                     <p>CONDICIONES FÍSICAS ACTUALES DEL AUTOMOTOR QUE DEBEN SUBSANARSE O REPARSE, REPORTADO DURANTE EL PROCESO DE INSPECCIÓN</p>
                  ...
                  <section className={ isResponsive
                     ...
                     <section className="notes-expenses no-border">
                        <article className="total">
                           <p>VALOR DE PRESUPUESTO ESTIMADO</p>
